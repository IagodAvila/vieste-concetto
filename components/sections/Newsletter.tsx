export function Newsletter() {
  return (
    <section className="bg-peach px-4 py-20 text-clay md:px-10 md:py-28" id="contato" aria-labelledby="newsletter-title">
      <div className="mx-auto max-w-xl text-center">
        <h2 className="font-serif text-3xl md:text-4xl" id="newsletter-title">Novidades chegam primeiro aqui.</h2>
        <p className="mt-4 text-sm opacity-80">Coleções, editoriais e pré-lançamentos — sem excessos na sua caixa de entrada.</p>
