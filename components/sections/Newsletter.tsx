  ...
  return (
    <section className="bg-peach px-4 py-20 text-graphite md:px-10 md:py-28" id="contato" aria-labelledby="newsletter-title">
      <div className="mx-auto max-w-xl text-center">
        ...
        <form className="mt-8 flex flex-col gap-3 sm:flex-row"><div className="flex-1 text-left"><label className="sr-only" htmlFor="newsletter-email">Seu e-mail</label><input className="h-13 w-full border border-clay/40 bg-transparent px-4 text-sm outline-none placeholder:opacity-60 focus:border-clay" id="newsletter-email" type="email" placeholder="seu@email.com" /></div><button type="submit" className="button-primary eyebrow h-13 px-8">Cadastrar</button></form>
      </div>
    </section>
  );
}
