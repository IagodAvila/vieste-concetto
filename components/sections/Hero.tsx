  ...
  return (
    <section className="relative h-[82vh] min-h-[520px] w-full overflow-hidden bg-secondary" id="top">
      ...
      <div className="relative flex h-full flex-col items-start justify-end px-6 pb-16 md:px-14 md:pb-20">
        <Image src="/assets/logo-vieste.svg" alt="VIESTE CONCETTO" width={1098} height={423} className="h-auto w-48 invert md:w-64" />
        <h1 className="mt-6 max-w-xl font-script text-3xl leading-[1.15] text-white md:text-5xl">Formas que acompanham o seu movimento</h1>
