  ...
  return (
    <article className="group relative">
      <div className="relative overflow-hidden bg-secondary">
        <Image src={product.image} alt={`${product.name} — ${product.category}`} width={1000} height={1500} sizes="(min-width:1024px) 25vw, 50vw" className="aspect-2/3 w-full object-cover" />
