...
export function Editorial() {
  return (
    <section className="pb-20 md:pb-28" aria-labelledby="editorial-title">
      <div className="mx-auto max-w-[1600px] px-4 md:px-10"><div className="flex items-end justify-between gap-6"><div><p className="eyebrow text-clay">@viesteconcetto</p><h2 className="mt-3 font-serif text-3xl md:text-4xl" id="editorial-title">Editorial</h2></div><a className="eyebrow link-underline" href="#editorial-title">Seguir</a></div></div>
