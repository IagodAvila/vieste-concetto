  ...
  return (
    <section aria-label="Coleção feminina">
      <div className="relative" id="feminino">
        <Image src="/assets/feminino.jpg" alt="Modelo em vestido longo de tricot em ambiente litorâneo minimalista" width={1008} height={1408} sizes="100vw" className="h-[72vh] w-full object-cover object-[center_38%] md:h-[86vh]" />
